...
<html>
    ...
    <%
        ...
        if (questions != null && categorys != null) {
    %>
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                    ...
                    <div class="sidebar-brand-text mx-3">Dashboard Participant</div>
                </a>
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="/TrainerFeedbacktest/dashboardPartisipant.jsp">
                        <i class="fas fa-fw fa-cog"></i>
                        <span>Dashbord</span></a>
                    <a class="nav-link" href="/TrainerFeedbacktest/fillform.jsp">
                        <i class="fas fa-fw fa-cog"></i>
                        <span>Fill Form</span></a>
                    <a class="nav-link" href="/TrainerFeedbacktest/presence.jsp">
                        <i class="fas fa-fw fa-cog"></i>
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <table>
                            <tr>
                                <td>Materi Program</td>
                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                                <td>WEEEEEEEEEEEEEEEEEEEEEEEE</td>
                            </tr>
                            <tr>
                                <td>Tempat & Waktu Pelaksanaan</td>
                                <td>&nbsp;&nbsp;:&nbsp;&nbsp;</td>
                                ...
                                <div class="table-responsive">    
                                    <form method="POST">
                                        ...
                                        <table id="tabel-data" class="table table-striped table-bordered" width="100%" cellspacing="0">
                                            <%if (category.getType().equals("MULTIPLE CHOICE")) {%>
                                            <tr align="center">
                                                <th></th>
                                                <th>1</th>
                                                <th>2</th>
